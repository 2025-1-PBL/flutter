...
class ScheduleService {
  ...
  // 일정 생성
  Future<dynamic> createSchedule(int userId, Map<String, dynamic> scheduleData) async {
    try {
      final headers = await _getHeaders();
  ...
  // 일정 수정
  Future<dynamic> updateSchedule(int scheduleId, int userId, Map<String, dynamic> scheduleData) async {
    try {
      final headers = await _getHeaders();
  ...
  // 일정 공유 상태 변경
  Future<dynamic> updateScheduleShareStatus(int scheduleId, bool isShared, int userId) async {
    try {
      final headers = await _getHeaders();
